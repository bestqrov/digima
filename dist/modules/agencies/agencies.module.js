...
const agencies_controller_1 = require("./controllers/agencies.controller");
...
exports.AgenciesModule = AgenciesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: agency_schema_1.Agency.name, schema: agency_schema_1.AgencySchema }])
        ],
